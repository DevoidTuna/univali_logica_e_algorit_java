...
public class Jokenpo {
    void main() {
        ...
        String tesouraL3 =  "         ______)    ";
        String tesouraL4 =  "     __________)    ";
        String tesouraL5 =  "      (____)        ";
        String tesouraL6 =  "---.__(___)         ";
        String tesouraL7 =  "                    ";

        String tesouraXL1 = "   \\_____/         ";
        String tesouraXL2 = "---'\\ __/_)____    ";
        String tesouraXL3 = "     \\/ ______)    ";
        String tesouraXL4 = "      X__________)  ";
        ...
        if (escolhaJogador < 1 || escolhaJogador > 3) {
            ...
            switch (escolhaJogador) {
                case 1:  nomeJogador = "PEDRA";   break;
                case 2:  nomeJogador = "PAPEL";   break;
                default: nomeJogador = "TESOURA";
            }

            String nomeComputador;
            switch (escolhaComputador) {
                case 1:  nomeComputador = "PEDRA";   break;
                case 2:  nomeComputador = "PAPEL";   break;
                default: nomeComputador = "TESOURA";
            }
            ...
            System.out.println(j1 + "  " + c1);
            System.out.println(j2 + "  " + c2);
            System.out.println(j3 + "  " + c3);
            System.out.println(j4 + "  " + c4);
            System.out.println(j5 + "  " + c5);
            System.out.println(j6 + "  " + c6);
            System.out.println(j7 + "  " + c7);

            System.out.println("------------------------------------------\n");

            switch (resultado) {
                case 0:  System.out.println(">>  EMPATE! Ninguém venceu desta vez.  <<"); break;
                case 1:  System.out.println(">>  PARABÉNS! Você VENCEU!             <<"); break;
                default: System.out.println(">>  Que pena... O computador VENCEU!   <<");
            }
